                ...
                <div className="duration-300"
                        ...
                        <div className='container mx-auto w-full h-auto pb-16 pt-10 px-4'>
                            <div
                                ...
                                <div className='mt-8 md:mt-12 px-2 space-y-1'>
                                    ...
                                    <div className={'flex items-center space-x-2'}>
                                        <PhoneIcon className={'w-4'}/>
                                        <a href="tel:+92 51 8990397" className='text-sm'> +92 51 8990397</a>
                                    </div>
                                    <div className={'flex items-center space-x-2'}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                             className="bi bi-whatsapp w-4 p-px" viewBox="0 0 16 16">
                                ...
                                <div className='mt-8 md:mt-12 px-2 space-y-1'>
                                    ...
                                    <div className={'flex items-center space-x-2'}>
                                        <PhoneIcon className={'w-4'}/>
                                        <a href="tel:+92 423 2020419" className='text-sm'> +92 423 2020419</a>
                                    </div>
                                    <div className={'flex items-center space-x-2'}>
                                        <PhoneIcon className={'w-4'}/>
                    ...
                    <div className='p-2 bg-accent-lighter'>
                        <div
                            ...
                            <p>| Powered by&nbsp;
                                <a href="https://www.theadvertizers.com/">
                                    The Advertizers.
                                </a>
                            </p>
                        </div>
